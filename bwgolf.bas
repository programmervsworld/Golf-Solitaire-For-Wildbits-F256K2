...
3050 if cursorRow > 0
3060 cursorRow = cursorRow - 1
3070 getcursorval()
3080 updatecursorpos()
3090 endif
3100 print "Press!"
3110 renderboard()
3120 endif
...
3150 proc gameloop()
3160 setup()
3170 updatecursorpos()
3180 getcursorval()
3190 sprite 53 image ?($7800+discardptr) to 126, 206
3200 repeat
3210 checkforlose()
3220 checkforwin()
3230 if event(tevent, 5)
3240 updateinput()
3250 if debugmode=true
3260 printdebugstuff()
3270 endif
3280 endif
3290 until isRunning=0
3300 endproc
ÿÿÿÿ
